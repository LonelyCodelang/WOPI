...
namespace MainWeb.Controllers.Api
{
    ...
    public class FilesController : ApiController
    {
        ...
        public CheckFileInfo Get(string name, string access_token)
        {
            ...
            fileInfo.WebEditingDisabled = false;
            fileInfo.RestrictedWebViewOnly = false;
            fileInfo.ReadOnly = false;
            fileInfo.SupportsUpdate = true;
            fileInfo.SupportsLocks = true;
            fileInfo.SupportsCoauth = false;
            fileInfo.SupportsCobalt = true;
            fileInfo.SupportsFolders = true;
            fileInfo.SupportsScenarioLinks = false;
            fileInfo.SupportsSecureStore = true;
            return fileInfo;
        }
